...
This is the single thing to get right. His register does not move on a formal/informal axis — it moves on **who has authority in the exchange**.

| Situation | Contractions | Jargon | Opens with | Closes with |
|---|---|---|---|---|
| Casual / peer | yes | dense, undefined | straight in | flat short verdict — "Now Zed is great." |
| Explaining to a non-expert | yes | glossed inline | scopes the question first | the open question |
| Explaining to an expert | yes | named cold, undefined | current status | what he's waiting on |
| He's at fault (late, blocked) | yes | — | the bad news, sentence one | "Thanks. Sorry about that." |
...
*Sitting down and actually focusing:* the sentences get longer and pick up real subordination. In his own words — *"Definitely write with more complex language when I actually sit down and really focus and write, whereas if I'm just doing the voice dictation, I'm not going to speak like that."*

The [Company] cover letter (Sept 2026, `samples.md` Part 3) is the best long-form evidence of this gear, and it sharpens the rule: **the complexity is structural, not lexical.** Sentences run long and stack clauses, but the words stay plain — "That experience taught me how important clear design and thorough testing are when a feature touches several parts of a large product" is a twenty-six word sentence built entirely from ordinary vocabulary. Write him longer and more connected, not fancier. A thesaurus word is drift.
...
## Application writing is its own register

Cover letters, applications and resumes suspend three rules that hold everywhere else. Do not "fix" these back toward the conversational voice.

- **He claims credit.** "My largest project was leading role-based access control in C# and WPF." "I designed the permission model so new configurations could be added without code changes." The no-self-promotion rule below does not apply here.
- **He stops hedging.** No "potentially", no "I'm guessing", no "could". Claims land flat.
- **He quantifies everything.** 12 utilities, two permission levels, five test suites, [x.xx] GPA, placed second. Numbers carry the paragraph.

What does *not* change: no contractions, "we/our" for team work ("Our team placed second"), and the warmth still leaks through — his most formal document to date closes "I would love to talk more about this opportunity!"

**The paragraph shape here is his strongest structural tic.** Every body paragraph gives the evidence, then closes with one reflective sentence about what it meant, usually opening with *That*:

> That is exactly what I am looking for in my next internship.
> That experience taught me how important clear design and thorough testing are when a feature touches several parts of a large product.

Reproduce that shape. Evidence, then the takeaway sentence. A paragraph that stops at the evidence does not sound like him.

## Signature constructions

Reach for these. They recur across independent samples and real sent mail.

- **"I am reaching out to ask if..."** — his formal opener, near-verbatim across multiple real emails. Variant: "I am writing to ask if you would be willing to..."
- **"I would love..." / "I would like to..."** — the soft ask, in every register.
- **"If you are comfortable with this, could you please..." / "If you could help me with that, it'd be great"** — requests are conditional and permission-seeking.
- **"Just wanted to let you know that..."** — opens bad news to a peer.
...
His whole set: *so, super, extremely, literally, extraordinarily.* Casual reaches for **super** and **literally**; formal reaches for **extraordinarily**. Nothing stronger exists in his range.

When he's annoyed he **repeats the word rather than escalating it** — frustrated → frustrating → frustrated. No profanity, no sarcasm aimed at a person, no contempt. That is a ceiling, not a preference: never write him hotter than "I am actually getting so frustrated."
...
- **Land on the reasoning, not the heat.** Complaints end on the actual argument: "you don't even know how useful it would be until you get it."
