...
- **The named skill isn't in `~/Developer/skills/skills`** — do **not** improvise a substitute. → **Blocked**, comment naming the missing skill and pointing at `skillify` to build it.
